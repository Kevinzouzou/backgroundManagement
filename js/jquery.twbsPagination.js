...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        render: function (pages) {
            ...
            this.$listContainer.find('.page').removeClass('page-active');
            this.$listContainer.find('.page').filter('[data-page="' + pages.currentPage + '"]').addClass('page-active');
        ...
        setupEvents: function () {
            ...
            this.$listContainer.find('li').each(function () {
                var $this = $(this);
                $this.off();
                if ($this.hasClass('disabled') || $this.hasClass('page-active')) return;
                $this.click(function () {
